...
const FIGHTER_DB = {
  ...
  "Umar Nurmagomedov": {
    ...
    weaknesses:["limited sample vs elite strikers","relatively new to UFC top 5"],
    wrestlerResilience:10, reachDisadvantageHandling:7, speedVsHandsHandling:7, yearsInactive:0, recentForm:9,
    styleMatchups:{"Striker":10,"Kickboxer":9,"Power Striker":8,"Counter Striker":7,"Flashy Striker":10,"Pressure Fighter":5,"Brawler":4,"Wrestler":0,"Grappler":1,"BJJ Specialist":-1,"Complete Fighter":0},
    opponentQuality:80,
    stats:{slpm:3.4,stracc:50,sapm:2.1,strdef:68,tdavg:3.8,tdacc:52,tddef:85,subavg:0.9,winStreak:18,finishRate:67},
    pastMatchups:{},
  },
  "David Martinez": {
    name:"David Martinez",record:"14-2",rank:"#9 BW",country:"\u{1F1EA}\u{1F1F8}",age:28,
    weightClass:"Bantamweight",naturalWeight:135,reach:70,style:"Kickboxer",
    tendencies:["technical striking","long jab","body kicks","patient approach","counter punching"],
    strengths:["reach for BW","technical striking","composure","accuracy"],
    weaknesses:["elite wrestling","grappling when taken down","limited finishing ability vs top fighters"],
    wrestlerResilience:5, reachDisadvantageHandling:7, speedVsHandsHandling:7, yearsInactive:0, recentForm:8,
    styleMatchups:{"Wrestler":-6,"Grappler":-5,"BJJ Specialist":-7,"Sambo / Wrestler":-8,"Pressure Fighter":3,"Striker":3,"Power Striker":2,"Counter Striker":2,"Flashy Striker":2,"Brawler":2,"Complete Fighter":-2},
    opponentQuality:75,
    stats:{slpm:4.8,stracc:52,sapm:3.4,strdef:60,tdavg:0.4,tdacc:28,tddef:62,subavg:0.2,winStreak:3,finishRate:50},
    pastMatchups:{},
  },
  "Shara Magomedov": {
    name:"Shara Magomedov",record:"16-1",rank:"#4 MW",country:"\u{1F1F7}\u{1F1FA}",age:29,
    weightClass:"Middleweight",naturalWeight:185,reach:76,style:"Kickboxer",
    tendencies:["spinning attacks","unorthodox angles","explosive combinations","showboating","highlight KOs"],
    strengths:["power","unorthodox movement","spinning techniques","KO threat","athleticism"],
    weaknesses:["grappling","wrestling defense","can be reckless","limited top-level sample"],
    wrestlerResilience:5, reachDisadvantageHandling:6, speedVsHandsHandling:9, yearsInactive:0, recentForm:9,
    styleMatchups:{"Wrestler":-5,"Grappler":-4,"BJJ Specialist":-6,"Sambo / Wrestler":-5,"Pressure Fighter":4,"Striker":3,"Counter Striker":3,"Power Striker":2,"Flashy Striker":2,"Brawler":2,"Complete Fighter":-2},
    opponentQuality:78,
    stats:{slpm:5.8,stracc:51,sapm:3.9,strdef:57,tdavg:0.3,tdacc:22,tddef:61,subavg:0.1,winStreak:8,finishRate:88},
    pastMatchups:{},
  },
  "Manuel Torres": {
    name:"Manuel Torres",record:"17-3",rank:"#12 LW",country:"\u{1F1F2}\u{1F1FD}",age:29,
    weightClass:"Lightweight",naturalWeight:155,reach:72,style:"Pressure Fighter",
    tendencies:["relentless forward pressure","heavy combinations","brawls in pocket","high output","aggressive pace"],
    strengths:["pressure","volume","finishing ability","toughness","pace"],
    weaknesses:["grappling defense","can be countered at range","chin tested by elite strikers"],
    wrestlerResilience:5, reachDisadvantageHandling:6, speedVsHandsHandling:7, yearsInactive:0, recentForm:8,
    styleMatchups:{"Counter Striker":3,"Flashy Striker":4,"Kickboxer":2,"Striker":2,"Wrestler":-3,"Grappler":-2,"BJJ Specialist":-4,"Sambo / Wrestler":-3,"Pressure Fighter":0,"Complete Fighter":-2,"Power Striker":1},
    opponentQuality:74,
    stats:{slpm:6.2,stracc:46,sapm:5.1,strdef:51,tdavg:0.4,tdacc:25,tddef:59,subavg:0.1,winStreak:2,finishRate:82},
    pastMatchups:{},
  },
  "Michel Pereira": {
    name:"Michel Pereira",record:"32-14-2",rank:"#14 MW",country:"\u{1F1E7}\u{1F1F7}",age:31,
    weightClass:"Middleweight",naturalWeight:185,reach:77,style:"Flashy Striker",
    tendencies:["backflip kicks","spinning attacks","wild unorthodox movement","showboating","unpredictable combos"],
    strengths:["athleticism","unorthodox style","entertainment","reach","surprise factor"],
    weaknesses:["grappling","inconsistency","wrestling defense"],
    wrestlerResilience:5, reachDisadvantageHandling:7, speedVsHandsHandling:8, yearsInactive:0, recentForm:6,
    styleMatchups:{"Wrestler":-5,"Grappler":-4,"BJJ Specialist":-6,"Sambo / Wrestler":-5,"Pressure Fighter":2,"Striker":2,"Counter Striker":2,"Power Striker":1,"Kickboxer":1,"Brawler":2,"Complete Fighter":-3},
    opponentQuality:76,
    stats:{slpm:5.3,stracc:44,sapm:4.8,strdef:52,tdavg:0.5,tdacc:27,tddef:57,subavg:0.3,winStreak:1,finishRate:65},
    pastMatchups:{},
  },
};
...
const UPCOMING_EVENTS = [
  ...
  },
  {
    ...
    fights:[
      {f1:"Rafael Fiziev",f2:"Manuel Torres",weightClass:"Lightweight",isMain:true,
        ...
        <div style={{width:"50%",position:"relative",overflow:"hidden",background:"#fff"}}>
          {imgs[0]?.primary
            ? <img src={imgs[0].primary} alt={f1.name}
                style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"contain",objectPosition:"bottom center",mixBlendMode:"multiply"}}
        ...
        <div style={{width:"50%",position:"relative",overflow:"hidden",background:"#fff"}}>
          {imgs[1]?.primary
            ? <img src={imgs[1].primary} alt={f2.name}
                style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"contain",objectPosition:"bottom center",transform:"scaleX(-1)",mixBlendMode:"multiply"}}
                onError={e=>{ e.target.style.display='none'; }}/>
            : <div style={{position:"absolute",inset:0,display:"flex",alignItems:"flex-end",justifyContent:"center",paddingBottom:8}}>
